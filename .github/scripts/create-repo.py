...
# Mihon repo metadata. Mihon fetches this when adding the repo; without it the
# repo is rejected as an "invalid URL". index_v2 = null keeps it on the legacy
# (index.min.json) format. signingKeyFingerprint enables auto-trust of our APKs.
repo_meta = {
    "index_v2": None,
    "meta": {
        "name": "ShatExtension",
        "website": "https://github.com/Dat-Ngu/ShatExtension",
        "signingKeyFingerprint": "0dc0d6b5d6399ab562c7c5f8ea31f702e254172a6044d194d33905ef68a80b0b",
    },
}
with REPO_DIR.joinpath("repo.json").open("w", encoding="utf-8") as repo_file:
    json.dump(repo_meta, repo_file, ensure_ascii=False)
