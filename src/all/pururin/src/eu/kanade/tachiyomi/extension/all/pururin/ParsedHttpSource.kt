...
/**
 * Local re-implementation of the (now removed from extensions-lib) ParsedHttpSource.
 * Extends HttpSource and supplies the classic jsoup selector/parse scaffolding.
 */
